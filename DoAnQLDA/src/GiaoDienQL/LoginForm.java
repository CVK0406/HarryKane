...
import GiaoDienNV.TrangChuNVForm;
...
public class LoginForm extends javax.swing.JFrame {
    ...
    private TrangChuForm tc;
    private TrangChuNVForm tcnv;
    ...
    private void initComponents() {
        ...
        lbLogo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/logo1.png")));
        ...
        btDangNhap.setBackground(new Color(82, 109, 130, 200));
        btDangNhap.setForeground(Color.WHITE);

        btDangNhap.addMouseListener(new MouseAdapter() {
            @Override
            public void mouseEntered(MouseEvent me) {
                btDangNhap.setBackground(new Color(82, 109, 130));
            }
    ...
    private void btDangNhapActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btDangNhapActionPerformed
        if(txtTenDN.getText().equals("HarryKane") && 
            ...
            tc.setVisible(true);
            this.dispose();
        } else if (txtTenDN.getText().equals("NV1") && 
                txtMatKhau.getText().equals("123456")) {
